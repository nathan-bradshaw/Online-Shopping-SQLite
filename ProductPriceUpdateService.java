...
class ProductPriceUpdateService {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting ProductPriceUpdate service at port = " + port);
    ...
    private static void serve(Socket socket, int clientID) throws Exception {
        ...
        try {
            ...
            System.out.println("Price from client " + clientID + ": " + price);
            Class.forName("org.sqlite.JDBC");
            SQLiteDataAdapter adapter = new SQLiteDataAdapter();
            adapter.connect("jdbc:sqlite:store.db");
            adapter.updateProductPrice(id, price);
