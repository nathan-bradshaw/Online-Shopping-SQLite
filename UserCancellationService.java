...
class UserCancellationService {
    public static void main(String[] args) throws Exception {
        ...
        // server is listening on port 5055
        ...
        System.out.println("Starting UserCancellation service at port = " + port);
    ...
    private static void serve(Socket socket, int clientID) throws Exception {
        try {
            ...
            System.out.println("OrderId from client " + clientID + ": " + orderId);
            Class.forName("org.sqlite.JDBC");
            SQLiteDataAdapter adapter = new SQLiteDataAdapter();
            adapter.connect("jdbc:sqlite:store.db");
            int status = adapter.checkUserCancel(username, orderId);
    ...
    private static boolean register(String regHost, int regPort, String myHost, int myPort) throws IOException {
        ...
        info.serviceCode = ServiceInfoModel.USER_CANCELLATION_SERVICE;
